...
public class Main {
  ...
  public static void testTagbody() {
    ...
    tagbody(() -> System.out.println("Hello world!"),
            tag1,
            () -> System.out.println("This should get printed twice"),
            code1,
  ...
  public static void testBlock() {
    System.out.println(new Block<>((block) -> "Hello world!").run());
  ...
  public static void testGrasp() {
    System.out.println(new Grasp<>(42, () -> "Hello world!").run());
